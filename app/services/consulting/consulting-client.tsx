...
export default function ConsultingClient() {
  ...
  const t = translations[language].servicePages.consulting
      ...
      <main className="pt-20">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">{t.concernsTitle}</h2>
              <div className="grid md:grid-cols-2 gap-6">
                {t.concerns.map((item: string) => (
                  <div key={item} className="bg-gray-50 p-6 rounded-lg border-l-4 border-teal-600">
        ...
        <section className="bg-teal-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 text-teal-100">{t.ctaSubtitle}</p>
            <Link
              href="/#contact"
