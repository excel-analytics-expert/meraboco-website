...
import { Award, Globe, Layers, MapPin, Search, ShieldCheck, Sparkles } from "lucide-react"
...
export default function ProDemoClient({ site, siteError, news, newsError }: ProDemoClientProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] text-stone-800">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(10, 16, 26, 0.55), rgba(10, 16, 26, 0.35)), url(${heroImageUrl})`,
      ...
      >
        ...
        <motion.div
          ...
          variants={fadeIn}
        >
          <div className="flex items-center justify-center gap-2 text-xs uppercase tracking-[0.4em] text-white/70">
      ...
      >
        <div className="mx-auto grid max-w-6xl gap-12 px-6 md:grid-cols-[1.1fr_0.9fr] md:items-center relative z-10">
          ...
          <div className="glass-crystal-demo rounded-3xl p-8 shadow-xl border border-stone-200/50">
            <p className="text-xs font-bold tracking-[0.25em] text-amber-500 uppercase">{t.featuresLabel}</p>
            <h3 className="text-xl font-bold text-stone-800 tracking-wide mt-3">{t.aboutSubtitle}</h3>
            <p className="mt-4 text-sm leading-relaxed text-stone-600 font-medium">{t.aboutText}</p>
      ...
      >
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          <div className="mb-12">
            <p className="text-sm font-semibold tracking-[0.25em] text-amber-700/80 uppercase">{t.featuresLabel}</p>
            <h2 className="mt-4 text-3xl font-bold text-stone-800 tracking-wide">{t.featuresTitle}</h2>
            <p className="mt-4 text-base text-stone-600 max-w-2xl">{featuresIntro}</p>
          </div>
      ...
      >
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 flex items-center gap-3 text-amber-700/80">
            <Award className="h-5 w-5" />
            <p className="text-xs font-semibold tracking-[0.25em]">{t.pagesLabel}</p>
          </div>
          <h2 className="mt-2 text-3xl font-semibold text-stone-800">{t.pagesTitle}</h2>
      ...
      >
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12 flex items-end justify-between">
            ...
            <p className="text-sm text-stone-400">{t.newsNote}</p>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 md:flex-row">
            ...
            <a
              ...
              className="w-full rounded-full border border-stone-200/50 bg-stone-50 px-8 py-4 text-base font-bold text-stone-800 shadow-xl transition-all duration-700 hover:-translate-y-1 hover:bg-stone-100 md:w-auto"
              target="_blank"
              rel="noreferrer"
            >
