...
export default function Header() {
  ...
  const navItems = [
    ...(pathname !== "/" ? [{ href: "/", label: t("header.homeBack") }] : []),
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <nav className="hidden lg:flex items-center gap-1 xl:gap-2" role="navigation" aria-label="メインナビゲーション">
              ...
              <Link
                ...
                className="px-3 py-2 text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors duration-200"
              >
                {t("header.portal")}
              </Link>
          ...
          <div className="flex-1 overflow-y-auto px-6">
            <ul className="space-y-1">
              ...
              <li>
                <Link
                  href="/portal/dashboard"
                  className="flex items-center justify-between px-4 py-4 rounded-xl font-medium transition-all duration-200 text-gray-800 hover:bg-gray-50 active:bg-gray-100"
                  onClick={closeMenu}
                >
                  <span className="flex items-center gap-3">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
